...
export default function Navbar() {
  ...
  return (
    <nav className={`fixed top-0 z-50 w-full border-b border-white/10 bg-gradient-to-b from-[#030303]/95 via-[#030303]/90 to-[#030303]/85 px-4 sm:px-6 lg:px-8 py-5 backdrop-blur-3xl shadow-2xl shadow-black/50 transition-all duration-500 ${isVisible ? 'translate-y-0 shadow-2xl' : '-translate-y-full shadow-none'}`}>
      <div className="mx-auto max-w-[1400px] flex items-center justify-between gap-4 md:gap-8 lg:gap-12">
