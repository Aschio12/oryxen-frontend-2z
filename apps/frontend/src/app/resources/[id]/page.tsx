            ...
            <article className="space-y-8 motion-reveal">
                ...
                <div className="space-y-4">
                  {[
                    ...
                    <div key={idx} className="flex gap-3">
                      <span className="flex h-6 w-6 items-center justify-center rounded-full bg-[#C5A059]/20 text-xs text-[#C5A059] font-semibold flex-shrink-0 mt-0.5">{idx + 1}</span>
                      <p className="text-sm font-light text-white/70">{takeaway}</p>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div className="rounded-xl border border-white/10 bg-[#0A0A0A] p-8">
                ...
                <div className="flex gap-4">
                  <Link href="/resources" className="rounded-lg border border-[#C5A059]/30 bg-[#C5A059]/10 px-6 py-3 text-[10px] uppercase tracking-wider text-[#C5A059] hover:bg-[#C5A059]/20 transition-all">
                    Browse All Resources
                  </Link>
                  <Link href="/programs" className="rounded-lg border border-[#C5A059] bg-[#C5A059] px-6 py-3 text-[10px] uppercase tracking-wider text-black hover:bg-transparent hover:text-[#C5A059] transition-all">
                    Explore Programs
                  </Link>
                </div>
              </div>
